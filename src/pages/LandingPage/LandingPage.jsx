...
// Create a mapping for group images
const groupImages = {
  4: group4,
  5: group5,
  6: group6,
        ...
        <div className="row">
          {[4, 5, 6, 7].map((num) => (
            <div className="col" key={num}>
              <img src={groupImages[num]} alt={`Process ${num}`} />
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi
                libero, alias laudantium veniam debitis doloribus velit fugit
                consequatur a eligendi iure laborum itaque! Accusamus aliquid
                vel, ad natus eligendi quae.
              </p>
            </div>
          ))}
        </div>
