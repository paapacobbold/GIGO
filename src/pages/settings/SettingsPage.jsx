...
import { Save, Bell, User, Shield, CreditCard, HelpCircle, Moon, Sun, ToggleLeft, ToggleRight, ChevronRight, MapPin, Trash2, Clock, Globe } from 'lucide-react';
     ...
     <div className="settings-container">
      ...
      <div className="settings-content">
        <div className="settings-sidebar">
          <nav>
            <ul>
              <li className="active"><a href="#notifications"><Bell size={18} /> Notifications</a></li>
              <li><a href="#account"><User size={18} /> Account</a></li>
              <li><a href="#privacy"><Shield size={18} /> Privacy</a></li>
              <li><a href="#collection"><Trash2 size={18} /> Collection Preferences</a></li>
              <li><a href="#payment"><CreditCard size={18} /> Payment Methods</a></li>
              <li><a href="#help"><HelpCircle size={18} /> Help & Support</a></li>
            </ul>
          </nav>
        </div>
        ...
        <div className="settings-main">
          <section id="notifications" className="settings-section">
            <h2>Notifications</h2>
            <p className="section-description">Configure how and when you receive notifications about waste collection and account updates.</p>
            ...
            <div className="settings-group">
              ...
              <div className="setting-item">
                ...
                >
                  {notifications.email ? <ToggleRight size={24} /> : <ToggleLeft size={24} />}
                </button>
              </div>
              ...
              <div className="setting-item">
                ...
                <button 
                  className={`toggle-button ${notifications.sms ? 'active' : ''}`}
                  onClick={() => handleNotificationChange('sms')}
                >
                  {notifications.sms ? <ToggleRight size={24} /> : <ToggleLeft size={24} />}
                </button>
              </div>
              ...
              <div className="setting-item">
                ...
                >
                  {notifications.push ? <ToggleRight size={24} /> : <ToggleLeft size={24} />}
                </button>
              </div>
            </div>
            ...
            <div className="settings-group">
              ...
              <div className="setting-item">
                ...
                <button 
                  className={`toggle-button ${notifications.pickupReminders ? 'active' : ''}`}
                  onClick={() => handleNotificationChange('pickupReminders')}
                >
                  {notifications.pickupReminders ? <ToggleRight size={24} /> : <ToggleLeft size={24} />}
                </button>
              </div>
              ...
              <div className="setting-item">
                ...
                <button 
                  className={`toggle-button ${notifications.paymentAlerts ? 'active' : ''}`}
                  onClick={() => handleNotificationChange('paymentAlerts')}
                >
                  {notifications.paymentAlerts ? <ToggleRight size={24} /> : <ToggleLeft size={24} />}
                </button>
              </div>
              ...
              <div className="setting-item">
                ...
                <button 
                  className={`toggle-button ${notifications.promotionalMessages ? 'active' : ''}`}
                  onClick={() => handleNotificationChange('promotionalMessages')}
                >
                  {notifications.promotionalMessages ? <ToggleRight size={24} /> : <ToggleLeft size={24} />}
                </button>
              </div>
            </div>
          </section>
          ...
          <section id="account" className="settings-section">
            ...
            <div className="settings-group">
              ...
              <div className="setting-item">
                ...
                <button 
                  className={`toggle-button ${accountSettings.darkMode ? 'active' : ''}`}
          ...
          <section id="privacy" className="settings-section">
            ...
            <p className="section-description">Control how your data is collected and shared.</p>
            
            <div className="settings-group">
              <div className="setting-item">
                <div>
                  <h4>Location Sharing</h4>
                  <p>Allow the app to access your location for better service</p>
                </div>
                <button 
                  className={`toggle-button ${privacySettings.shareLocation ? 'active' : ''}`}
              ...
              <div className="setting-item">
                ...
                <button 
                  className={`toggle-button ${privacySettings.shareUsageData ? 'active' : ''}`}
                  onClick={() => handlePrivacyChange('shareUsageData')}
                >
                  {privacySettings.shareUsageData ? <ToggleRight size={24} /> : <ToggleLeft size={24} />}
                </button>
              </div>
              ...
              <div className="setting-item">
                ...
                <button 
                  className={`toggle-button ${privacySettings.allowThirdPartyData ? 'active' : ''}`}
                  onClick={() => handlePrivacyChange('allowThirdPartyData')}
                >
                  {privacySettings.allowThirdPartyData ? <ToggleRight size={24} /> : <ToggleLeft size={24} />}
                </button>
              </div>
            </div>
            
            <div className="privacy-links">
              <a href="#privacy-policy">View Privacy Policy <ChevronRight size={16} /></a>
              <a href="#data-request">Request My Data <ChevronRight size={16} /></a>
              <a href="#delete-account">Delete My Account <ChevronRight size={16} /></a>
            </div>
          </section>
          
          <section id="collection" className="settings-section">
            <h2>Collection Preferences</h2>
            <p className="section-description">Customize your waste collection schedule and preferences.</p>
            ...
            <div className="settings-group">
              <div className="setting-item">
                ...
                <select 
                  ...
                  onChange={(e) => handleCollectionChange('preferredDay', e.target.value)}
                >
              ...
              <div className="setting-item">
                ...
                <select 
                  ...
                  onChange={(e) => handleCollectionChange('preferredTimeSlot', e.target.value)}
                >
              ...
              <div className="setting-item">
                ...
                <button 
                  className={`toggle-button ${collectionPreferences.automaticScheduling ? 'active' : ''}`}
                  onClick={() => handleToggle('collection', 'automaticScheduling')}
                >
              ...
              <div className="setting-item">
                ...
                <select 
                  ...
                  onChange={(e) => handleCollectionChange('reminderTime', e.target.value)}
                >
          ...
          <section id="payment" className="settings-section">
            ...
            <p className="section-description">Manage your payment options and billing preferences.</p>
          ...
          <section id="help" className="settings-section">
            <h2>Help & Support</h2>
            <p className="section-description">Get assistance with your account or waste collection services.</p>
            ...
            <div className="help-options">
              <div className="help-option">
                ...
                <a href="#kb">View Articles <ChevronRight size={16} /></a>
              </div>
              ...
              <div className="help-option">
                ...
                <a href="#contact">Contact Us <ChevronRight size={16} /></a>
              </div>
              
              <div className="help-option">
                <Trash2 size={24} />
                <h3>Recycling Guide</h3>
                <p>Learn how to properly sort and recycle different materials</p>
                <a href="#guide">View Guide <ChevronRight size={16} /></a>
              </div>
            </div>
          </section>
        </div>
